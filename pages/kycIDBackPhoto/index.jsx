...
import { uploadKycBackPhoto } from "../../api/api";
...
const kycBackPhoto = () => {
    ...
    const sendPhoto = async () => {
        try {
            const { data, status } = await uploadKycBackPhoto(imgSrc);
    ...
    return (
        <>
            ...
            />
            <Container>
                <CustomTitle>ID card back photo</CustomTitle>
                {imgSrc ? (
                    <Container>
                        <ImgContainer>
                            <Image
                ...
                <CustomDescription>
                    Take a picture of the back side of your ID
                </CustomDescription>
                <CustomDescription>
